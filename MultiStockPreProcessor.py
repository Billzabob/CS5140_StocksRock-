...
if __name__ == "__main__":
    ...
    model = MultiStockPreProcessor.GetAnalyzerForCompanies(companies,
                   ...
                   'slope160','movAvgDiff20','movAvgDiff40', 'movAvgDiff80','movAvgDiff160','var20','var40','var80','var160',
                                                                     'max5D', 'max10D', 'max25D', 'max50', 'max100',
                                                                     'min5D', 'min10D', 'min25D', 'min50', 'min100',
                                                                     ...
                                                                     'dow_var160'],
                                                           yColumns=['5DayActual','10DayActual','50DayActual'], valColumn='open', cvPercent=.1, cvSelection='top')
