        ...
        for i in range(len(degrees)):
            ...
            if (length != 0):
                ...
                for x in range(0, length):
                    ...
                    Ys.append(current)
                    if(guess[0][0] > 1.02):
                        size = ((guess[0][0] - 1.02)*100) + 5
                        plt.plot(x, current, marker='o', linestyle='--', color='g', markersize=size)
                        bought5D += actual[0] - 1
                    if(guess[0][0] < .97):
                        size = ((.98 - guess[0][0]) * 100) + 5
                        plt.plot(x, current, marker='o', linestyle='--', color='b', markersize=size)
                        sold5D += 1 - actual[0]
                    if (guess[0][1] > 1.04):
                    ...
                    if (guess[0][2] > 1.06):
                        ...
                        size = ((guess[0][0] - 1.06) * 100) + 5
                        plt.plot(x, current, marker='o', linestyle='--', color='r', markersize=size)
                    if (guess[0][2] < .94):
                        sold50D += 1 - actual[2]
                        size = ((.94 - guess[0][0]) * 100) + 5
                        plt.plot(x, current, marker='o', linestyle='--', color='orange', markersize=size)
                ...
                plt.plot(Xs,Ys, marker='o', color='k', linestyle='', markersize=1)
                plt.show()
